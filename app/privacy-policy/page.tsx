      ...
      <main className="flex-1">
        <section className="py-16 md:py-24 px-4">
          <div className="container mx-auto max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-serif text-[#3c4c30] mb-8 text-center">Privacy Policy</h1>
            
            <div className="prose prose-lg mx-auto text-[#5a5a5a]">
              <p className="text-center mb-8 italic">Last Updated: March 23, 2025</p>
              
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Introduction</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Information We Collect</h2>
              
              <h3 className="text-xl font-serif text-[#3c4c30] mt-6 mb-2">Personal Information</h3>
              <p>
              ...
              <h3 className="text-xl font-serif text-[#3c4c30] mt-6 mb-2">Information Automatically Collected</h3>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">How We Use Your Information</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Disclosure of Your Information</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Third-Party Links</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Data Security</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Your Choices</h2>
              
              <h3 className="text-xl font-serif text-[#3c4c30] mt-6 mb-2">Cookies</h3>
              <p>
              ...
              <h3 className="text-xl font-serif text-[#3c4c30] mt-6 mb-2">Marketing Communications</h3>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Children's Privacy</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Changes to This Privacy Policy</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Contact Us</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">South Carolina-Specific Privacy Information</h2>
              <p>
              ...
              <h2 className="text-2xl font-serif text-[#3c4c30] mt-8 mb-4">Your Rights Under Federal Law</h2>
              <p>
