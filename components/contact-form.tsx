  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-10">
      <fieldset className="min-w-0">
        <legend className="font-serif text-xl text-sage-dark">Your Information</legend>
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              required
              defaultValue=""
              className={getFieldError('contactMethod') ? 'border-red-500' : ''}
            >
      ...
      <fieldset className="min-w-0">
        <legend className="font-serif text-xl text-sage-dark">Property</legend>
        <div className="mt-6 space-y-6">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              required
              defaultValue=""
              className={getFieldError('propertyType') ? 'border-red-500' : ''}
            >
      ...
      <fieldset className="min-w-0">
        <legend className="font-serif text-xl text-sage-dark">Project Details</legend>
        <div className="mt-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Select
                ...
                required
                defaultValue=""
                className={getFieldError('projectTimeframe') ? 'border-red-500' : ''}
              >
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                required
                defaultValue=""
                className={getFieldError('budgetRange') ? 'border-red-500' : ''}
              >
